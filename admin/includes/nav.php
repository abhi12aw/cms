<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?= _get_username( _get_current_user_id() ) ?> <b class="caret"></b></a>
            <ul class="dropdown-menu">
                <li>
                    <a href="<?= $site_url . "admin/profile.php" ?>"><i class="fa fa-fw fa-user"></i> Profile</a>
                </li>
                <li>
                ...
                <li class="divider"></li>
                <li>
                    <a href="<?= $site_url . "admin/logout.php" ?>"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                </li>
            </ul>
        </li>
    </ul>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li <?php if( $current_page == 'profile.php' ) echo 'class="active"'; ?>>
                <a href="<?= $site_url . "admin/profile.php" ?>"><i class="fa fa-fw fa-dashboard"></i> Profile</a>
            </li>
        </ul>
    </div>
    <!-- /.navbar-collapse -->
